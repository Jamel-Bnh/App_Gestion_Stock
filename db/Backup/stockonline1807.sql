...
INSERT INTO `nw_ctg` VALUES (40,'DMLG','62418','maintenance logiciel'),(41,'DTEL','71148','telecom'),(42,'DTLC','71148','teleconduite');
...
INSERT INTO `nw_division` VALUES (17,'DMLG','71149','division maintence logiciel'),(18,'DTLC','62418','division teleconduite'),(19,'DTEL','62047','dd');
...
CREATE TABLE `tblog` (
  ...
  `type_op` varchar(250) NOT NULL,
  `elem` varchar(50) NOT NULL,
  `date_log` date NOT NULL,
  `pio` varchar(30) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tblog` VALUES (7,'71149','Logout','success','2022-07-18','Medium'),(11,'71149','Logout','success','2022-07-18','Medium'),(12,'71149','Login','failed','2022-07-18','High'),(13,'71148','Login','failed','2022-07-18','High'),(14,'71145','Login','failed','2022-07-18','High'),(15,'71149','Login','success','2022-07-18','Medium'),(16,'71149','Login','success','2022-06-24','Medium'),(17,'71149','Logout','success','2022-06-24','Medium'),(18,'71148','Login','success','2022-06-24','Medium'),(19,'71148','Logout','success','2022-06-24','Medium'),(20,'71149','Login','success','2022-06-24','Medium'),(21,'71149','Logout','success','2022-06-24','Medium'),(22,'71149','Login','success','2022-06-24','Medium'),(23,'71148','Login','success','2022-06-24','Medium'),(24,'71148','Logout','success','2022-06-24','Medium'),(25,'71149','Logout','success','2022-06-24','Medium'),(26,'62047','Login','success','2022-06-24','Medium'),(27,'62047','Logout','success','2022-06-24','Medium'),(28,'62047','Login','success','2022-06-24','Medium'),(29,'64923','Login','success','2022-06-24','Medium'),(30,'71145','Login','failed','2022-06-24','High'),(31,'71145','Login','success','2022-06-24','Medium');
...
INSERT INTO `users_stock` VALUES ('62047','Mizouni Mahdi','UMXX','DTEL','$2y$10$QPZqSwvKoBs/8cVEDSDNOuFL8YVigbrHcgm5eNbA1ia2OFfIwD0oW','N/A','N/A'),('62418','Laadhari Hatem','UMXX','DTLC','$2y$10$Lzbnc/P83aE2kfwbhgRWY.wXL93lMbB52zYFcuqdBpFKyRtUCStT6','N/A','N/A'),('64923','Smaoui Majdi','UMXX','DMLG','$2y$10$DcQ7Y/HQGwveeHx/qU.i4eNVi0u0eK8o0RlyLpEXbM49nAexQijBq','N/A','N/A'),('71136','Bejaoui Hamed','UXXX','DTEL','$2y$10$nTA.AtiQMAdlp0eObOd1e.XzWG3eB9sk/tobFMWj5zEoD/6pY4vHi','',''),('71145','Ben Abdallah Karim','UMXX','DTLC','$2y$10$zkPc/n/dERjbaiSzytv3ludy8JVEqiv.qoZnzQHe5bfNQevqlbCa.','',''),('71148','Laghmani Bacem','UMAX','DTLC','$2y$10$p8SlZBO1WVzVhnDrWEPqnOgKjJvyY4sBtCqcfEfrQXHF74//zcYgu','',''),('71149','Chaieb Farid ','UMAS','DMLG','$2y$10$bmKTjQF8/b2NrtGzUGWZWO9pG4VvrY4u6VviKJWKmvRsEzdqH2Oa2','','');
...
-- Dump completed on 2022-06-24 17:43:41
