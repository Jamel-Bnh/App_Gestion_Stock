...
INSERT INTO `log_info` VALUES (19,'LOG03147','Connexion','Connecter','réussi','REMARQUER'),(20,'LOG89233','Connexion','Connecter','erreur','ATTENTION'),(21,'LOG40720','Connexion','Deconnecter','réussi','REMARQUER'),(22,'LOG32553','Connexion','Deconnecter','erreur','DÉBOGUER'),(23,'LOG76621','Mot de passe','changer','réussi','ATTENTION'),(24,'LOG50305','Mot de passe','changer','erreur','ATTENTION'),(25,'LOG78451',' Base de données','connecter','réussi','REMARQUER'),(26,'LOG06152',' Base de données','connecter','erreur','CRITIQUE');
...
/*!40000 ALTER TABLE `log_niveau` DISABLE KEYS */;
INSERT INTO `log_niveau` VALUES (1,1,'URGENCE','Une condition de « panique » - avertir tout le personnel technique de garde ? (Tremblement de terre ? Tornade ?) - affecte plusieurs applications/serveurs/sites.','#dd2222'),(2,2,'ALERTE','Doit être corrigé immédiatement - informez le personnel qui peut résoudre le problème - un exemple est la perte de la connexion ISP de secours.','#0ae6cc'),(3,3,'CRITIQUE','Doit être corrigé immédiatement, mais indique une défaillance dans un système principal - résolvez les problèmes CRITIQUES avant ALERTE - un exemple est la perte de la connexion ISP principale.','#0d37de'),(4,4,'ERREUR','Échecs non urgents - ceux-ci doivent être transmis aux développeurs ou aux administrateurs ; chaque élément doit être résolu dans un délai donné.','#024fa2'),(5,5,'ATTENTION','Messages d\'avertissement - pas une erreur, mais indiquent qu\'une erreur se produira si aucune action n\'est entreprise, par exemple le système de fichiers est plein à 85 % - chaque élément doit être résolu dans un délai donné.','#e4c144'),(6,6,'REMARQUER','Les événements inhabituels mais pas les conditions d\'erreur - peuvent être résumés dans un e-mail aux développeurs ou aux administrateurs pour détecter les problèmes potentiels - aucune action immédiate n\'est requise.','#22dd7c'),(7,6,'DÉBOGUER','Les informations sont utiles aux développeurs pour déboguer l\'application, pas utiles pendant les opérations','#22dd7c');
/*!40000 ALTER TABLE `log_niveau` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `nw_ctg` VALUES (40,'DMLG','62418','maintenance logiciel'),(41,'DTEL','62418','telecom'),(42,'DTLC','71148','teleconduite');
...
INSERT INTO `nw_division` VALUES (17,'DMLG','71149','division maintence logiciel'),(18,'DTLC','62418','division teleconduite'),(19,'DTEL','62418','division telecom\r\n');
...
INSERT INTO `nw_location` VALUES (7,'EXT1','Armoire','A1E1','armoire a1 magasin externe','OK'),(8,'EXT1','Armoire','A1E2','armoire a1 magasin externe','OK'),(9,'EXT1','Armoire','A1E3','armoire a1 magasin externe','OK'),(10,'EXT1','Armoire','A1E4','armoire a1 magasin externe','OK'),(11,'EXT1','Armoire','A1E5','armoire a1 magasin externe','OK'),(12,'EXT1','Armoire','A1E6','armoire a1 magasin externe','OK'),(13,'EXT2','Armoire','AX1E1','armoire ax1','OK'),(14,'EXT2','Armoire','AX1E2','armoire ax1','OK'),(15,'EXT2','Armoire','AX1E3','armoire ax1','OK'),(16,'EXT2','Armoire','AX1E4','armoire ax1','OK'),(17,'EXT2','Armoire','AX1E5','armoire ax1','OK'),(18,'EXT1','Armoire','KAE1','fef','OK'),(19,'EXT1','Armoire','KAE2','fef','OK'),(20,'EXT1','Armoire','KAE3','fef','OK');
...
INSERT INTO `nw_magasin` VALUES (4,'EXT1','DPSGZ','magasin externe direction pilotage systeme gza','OK'),(5,'salle serveur','DMPS','département maintenance systeme de pilotage','OK'),(6,'EXT2','DPSG','magasin externe 2 direction pilotage systeme gaz','OK'),(7,'regfre','rgerg','gre','OK');
...
INSERT INTO `nw_panier` VALUES (60,'71149','PR8052683608',1,'DSQ003','DMLG'),(61,'71149','PR1773251104',1,'N/A','DMLG');
...
INSERT INTO `nw_role` VALUES (1,'UXXX','user'),(2,'UMXX','user magasiner'),(3,'UMAX','user magasinier admin\r\n'),(4,'UMAS','user magasinier admin super-admin\r\n');
...
INSERT INTO `tblog` VALUES (34,'71149','LOG89233','Connexion','Connecter','erreur','2022-07-20 22:07:11','ATTENTION','127.0.0.1'),(35,'71149','LOG03147','Connexion','Connecter','réussi','2022-07-20 22:07:15','REMARQUER','127.0.0.1'),(36,'71148','LOG89233','Connexion','Connecter','erreur','2022-07-20 22:07:46','ATTENTION','127.0.0.1'),(37,'62418','LOG89233','Connexion','Connecter','erreur','2022-07-20 22:07:49','ATTENTION','127.0.0.1'),(38,'71145','LOG03147','Connexion','Connecter','réussi','2022-07-20 22:07:54','REMARQUER','127.0.0.1'),(39,'71148','LOG89233','Connexion','Connecter','erreur','2022-07-20 22:07:07','ATTENTION','127.0.0.1'),(40,'71148','LOG03147','Connexion','Connecter','réussi','2022-07-20 22:07:11','REMARQUER','127.0.0.1'),(41,'71149','LOG03147','Connexion','Connecter','réussi','2022-07-20 22:07:58','REMARQUER','127.0.0.1');
...
INSERT INTO `users_stock` VALUES ('62047','Mizouni Mahdi','UMAX','DTEL','$2y$10$YGXcXImylN19TVWEzBuMM.tAX83Z0OYLTKbvrjvk7MFhTkjYUpfci','N/A','N/A'),('62418','Laadhari Hatem','UMXX','DTLC','$2y$10$Lzbnc/P83aE2kfwbhgRWY.wXL93lMbB52zYFcuqdBpFKyRtUCStT6','N/A','N/A'),('64923','Smaoui Majdi','UMXX','DMLG','$2y$10$QThqEtZVHK3iWxhGS.SET.Egdfy79ha4TKPbgPuRnYTe/j43HfsSC','N/A','N/A'),('71136','Bejaoui Hamed','UXXX','DTEL','$2y$10$nTA.AtiQMAdlp0eObOd1e.XzWG3eB9sk/tobFMWj5zEoD/6pY4vHi','',''),('71145','Ben Abdallah Karim','UMXX','DTLC','$2y$10$zkPc/n/dERjbaiSzytv3ludy8JVEqiv.qoZnzQHe5bfNQevqlbCa.','',''),('71148','Laghmani Bacem','UMAX','DTLC','$2y$10$p8SlZBO1WVzVhnDrWEPqnOgKjJvyY4sBtCqcfEfrQXHF74//zcYgu','',''),('71149','Chaieb Farid ','UMAS','DMLG','$2y$10$2JgzP/itoOMtJXr6EHALa.4JbT2SOk6eHf2mcIDsU7xHv8FXH/anm','frchaieb@steg.com.tn','22711859');
