...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            <input class="form-control" id="ctg_nw" style="width: 100%;text-align:center;color:#ffffff;background:#0077C0;margin-bottom:35px;cursor:no-drop;margin-bottom:35px;border-radius:0;cursor:no-drop; box-shadow: 3px 3px 2px 0px #000000;height: 42px;" value='<?php echo $ctg; ?>' readOnly>
