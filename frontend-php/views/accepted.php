...
if($user_role ==="UXXX" || $user_role==="UMXX"){
    ...
    <div class="row">
        ...
        <div class="req_w w-100">
            ...
            <thead class="th_info">
                ...
                <tbody>
                    <?php
                    $scan_wreq = mysqli_query($link_db, "SELECT * from bon_out WHERE sts_out='accepted'");
...
<script>
    $('document').ready(function() {
        ...
        $('.thetitle').html('<i class="fas fa-user-check"></i> '+cur_tit);
    })
